...
- **Fastest service: ~47 minutes.** Regular services ~1 hour.
...
Fastest route is actually by air, not rail:

**Recommended: fly CAN → HGH + transfer.**
- China Southern / Juneyao, ~2 hr, ~$100/person.
- Target a **09:00–11:00 departure** from CAN.
- Pre-book a private transfer **HGH → Wuzhen West Gate** through the guesthouse if possible. Realistically this is **about 75–90 minutes by car** in normal traffic, not a quick hop.
- Cheaper fallback: airport / coach transfer to Wuzhen, but that is closer to **2 hours** and less flexible.
- Total door-to-door is closer to **5.5–6.5 hours** once you include airport time and the road leg.
...
- **Hong Kong**: MTR goes everywhere. Octopus card tops up at any station or via Apple Pay.
- **Guangzhou**: Metro + DiDi. DiDi is inside Alipay (no separate app).
- **Shanghai**: Metro Lines 1, 2, 10 cover everything tourist-facing. Single-ride tickets via Alipay QR at any turnstile.

## Booking notes

- Cross-border and mainland HSR tickets generally open **15 days before departure** on **12306** and MTR's booking channels.
- Use the **same passport / ID document** for booking and boarding.
- West Kowloon baggage guideline: **20 kg per adult** and **130 cm total dimensions per piece**. This itinerary works much better with compact luggage than oversized rollers.
