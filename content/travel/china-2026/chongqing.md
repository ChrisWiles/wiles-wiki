...
Three nights, Nov 17–20. Chongqing is the 240-hour entry port and the trip’s most spatially surreal city: hills, river cliffs, monorails and layered streets.

## Where to stay

| Hotel | Area | Call |
|---|---|---|
| **Ascott Raffles City** | Chaotianmen | First choice for group apartments, laundry and landmark access |
...
Fly nonstop CKG → SHA/PVG. Prefer Hongqiao when timing is competitive.

## Food

- Peijie Old Hotpot for a central first experience; confirm the current branch in Amap/Dianping.
- Pipayuan only if the giant hillside setting is worth the extra drive.
- Eat xiaomian for breakfast; follow office-worker queues.
- Try Wanzhou grilled fish, lazi chicken and sour-hot sweet-potato noodles.
